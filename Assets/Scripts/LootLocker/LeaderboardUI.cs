...
{
    [SerializeField] string leaderboardKey = "globalhighscore";
    ...
    public void OnSubmitScoreTMP(TMP_InputField scoreInput)
    {
    ...
    public void OnSetNameTMP(TMP_InputField nameInput)
    {
        FindObjectOfType<Username>().SaveUsername();
    }
}
